...
export const CodeBlock: React.FC<CodeBlockProps> = ({
  ...
  if (inline) {
    return (
      <code
        {...props}
        className={`rounded-xl w-full bg-gray-200 px-2 py-1 text-sm ${className}`}
      >
        {children}
      </code>
    );
  ...
  return (
    <div className="group relative my-2 w-full  overflow-x-scroll rounded-md">
      {/* Header với thông tin ngôn ngữ */}
      <div
        className={`h-[50px] w-full flex items-center justify-between px-4 bg-primary/40`}
      >
